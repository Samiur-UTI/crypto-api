...
var dirPathRead = path.join(__dirname, '../../src/assets/transactions.csv');
// const dirPathWrite = path.join(__dirname, '../../src/assets/transactions.json');
var ReadService = /** @class */ (function () {
    function ReadService(transactionsRepository, connection, parsingService) {
    ...
    ReadService.prototype.read = function () {
        return __awaiter(this, void 0, void 0, function () {
            var dbCheck, connection, response, readStream;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.transactionsRepository.find()];
                    case 1:
                        dbCheck = _a.sent();
                        connection = this.connection;
                        response = 'Data already exists';
                        if (!dbCheck.length) {
                            readStream = fs.createReadStream(dirPathRead);
                            try {
                                readStream
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, this.parsingService.parse(data)];
                                            case 1:
                                                chunk = _a.sent();
                                                return [4 /*yield*/, connection
                                                        .getRepository(transaction_entity_1.Transactions)
