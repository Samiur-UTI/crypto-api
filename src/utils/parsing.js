...
var ParsingService = /** @class */ (function () {
    ...
    ParsingService.prototype.parse = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var dataArray, dataArrayLength, chunk, i, dataArraySplit, dataArraySplitLength, transaction, j;
            return __generator(this, function (_a) {
                ...
                for (i = 0; i < dataArrayLength; i++) {
                    ...
                    dataArraySplitLength = dataArraySplit.length;
                    transaction = {};
                    for (j = 0; j < dataArraySplitLength; j++) {
                        if (j === 0) {
